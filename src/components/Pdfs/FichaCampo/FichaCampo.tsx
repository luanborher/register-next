        ...
        <Main key={Number(index)}>
          <Content>
            ...
            <Terms>
              ...
              pagamento das contas de consumo de água e/ou esgoto do (s) imóvel
              (is), devo entrar em contato com a Sabesp para solicitar o
              encerramento da relação contratual, sob pena de se manter
